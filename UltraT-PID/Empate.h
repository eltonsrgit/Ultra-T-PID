...
void EstadoUpdate(){  // função que atualiza os estados
  ...
  if (leitura[0] && leitura[3]){  // enxergando inimigo com os 2 sensores
    EstadoAtual = 2;
  } else if (!leitura[0] && leitura[3]){ // enxergando com o direito
    EstadoAtual = 3;
  } else if (leitura[0] && !leitura[3]){ // enxergando com o esquerdo
    EstadoAtual = 4;
