...
void iSeeYou() { // não é uma estratégia e sim o ataque principal, mas pode ser selecionada no número 4 no controle, talvez já seja a padrão
  leituraSensores();
  pid();
